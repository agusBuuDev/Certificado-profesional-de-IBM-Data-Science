...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(
            filtered_df,
            names='class',  # Cambia 'class' a la columna apropiada en tu DataFrame
            title=f'Pie Chart for {entered_site}'  # Título personalizado para el gráfico
        )
...
def update_scatter_chart(selected_site, payload_range):
    ...
    # Filtrar el DataFrame por el rango de carga útil
    ...
    fig = px.scatter(
        ...
        title=f'Scatter Plot for {selected_site}' if selected_site != 'ALL' else 'Scatter Plot for All Sites'
    )
